...
이 저장소에는 기획 문서와 **참고 프로토타입 코드**가 있습니다 — 코어 27파일 · 화면 15파일 ·
시험 33섹션 617단언 · 검산기 3종. 화면 없이 AI 대 AI로 100회 자동 진행되는 M0 시뮬레이터가
...
| 서사 | 프롤로그 · 엔딩 10종 |
| AI · UI | 설계 초안 |
| **코드** | 참고 프로토타입 — 코어 27파일 · 화면 15파일 · 시험 617단언. M0 게이트 통과(2026-08-28) · S3 클라이언트 진행 중 (S3.5·S3.7·S3.8 잔여) |
