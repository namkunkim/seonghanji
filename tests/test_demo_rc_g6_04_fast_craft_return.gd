...
func _test_scope_contract()->void:
	...
	_eq(excluded,["in_battle_equipment_change","tactical_mission_effect","drift","rescue_result","capture_result","supply_source_stock","supply_source_damage","base_reloading"],"remaining deferred G6-05+ and supply-source effects stay out of scope")
