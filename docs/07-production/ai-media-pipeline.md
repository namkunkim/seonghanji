...
| ⚠ 상업적 이용 | ToS에 「승인되지 않은 commercial endeavor 금지」 문구. 통상 마케팅 사이트용 boilerplate이나 상용 게임 에셋이 목적이므로 **Compute/Marketplace 약관 별도 확인 또는 지원 문의** — 검토 4 잔여 |
...
| 4 | ~~클라우드 GPU 임대처의 약관~~ | **대체로 해소 — 2026-08-30.** RunPod Community 채택(§3.3). ToS 확인: 출력물 소유권 이용자 보유 · 모델 라이선스 불변 · 호스트의 파드 데이터 열람 금지(위반 시 즉시 퇴출) · AI 생성물 별도 제약 없음. **잔여 1건:** ToS의 「승인되지 않은 commercial endeavor 금지」 문구 — 상용 게임 에셋이 목적이므로 Compute/Marketplace 약관 별도 확인 또는 지원 문의 |
...
- [ ] **RunPod ToS 상업 이용 조항 확인** — Compute/Marketplace 약관 또는 지원 문의. 검토 4 잔여
