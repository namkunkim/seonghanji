...
> 상위: `docs/07-production/asset-ledger.md` · `DECISIONS.md` **V-43 · V-44**
...
| **권역 배경** `ART-R001~045` | 45 → 10~15 (미확정) | **AI + 자작 변주** |
...
| 2 | **권역 배경 물량이 미확정이다** | 대장 §4.2. 45 그대로인지 10~15로 묶는지가 §4.5 ⑤의 선행 |
