...
이번 UI는 자동 보급 영역, queue, 한 턴 정박, 중단, 처리 순위·처리량, 연료와 실제 G4 finite refill 완료만 다룬다. 비상·조기 귀환은 G6-04 전투 UI의 별도 viewer receipt가 담당한다. 임무 효과, 실제 표류·파괴·구조·나포, 보급원 재고·손상과 기지 재장전은 G6-05~06 범위이며 선점하지 않는다. 화면은 `Control` 기반 2D 전용이다.
