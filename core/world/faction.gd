...
## ---------------------------------------------------------------- 경제
##
## 천명(Mandate) 0~100. **사기에 직접 들어간다** (function-events.md §0.3-①)
##
## 「무엇이 통치의 정당한 근거인가」가 전장에서 수치가 되는 지점이다 —
...
## **연속 몇 달째 신규 권역을 얻지 못했는가** (function-events.md §0.3-⑤).
## 12개월이면 천명 −1/월, 24개월이면 −2/월. **가만히 있으면 진다**
var months_idle: int = 0
