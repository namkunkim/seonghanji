...
func _validate_rules(raw, setup: Dictionary) -> Dictionary:
	...
	var expected_out_of_scope := ["in_battle_equipment_change", "tactical_mission_effect", "automatic_return", "drift", "rescue_result", "capture_result", "supply_source_stock", "supply_source_damage", "base_reloading"]
