...
func _validate_rules(raw, setup: Dictionary) -> Dictionary:
	...
	var expected_out_of_scope := ["in_battle_equipment_change", "non_rescue_tactical_mission_effect", "actual_damage_trigger", "actual_destroy_trigger", "actual_boarding_trigger", "post_battle_captured_ship_reuse"]
