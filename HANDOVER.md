...
| **문서** | **41개** + HTML 지도 1개 |
| **코드** | **코어 26파일 · 화면 2파일 · 시험 32섹션 375단언 · 검산기 3종** |
...
S3.3  성역 뷰 (SC-L2)      명세 docs/06-tech/screens.md §2   🔄
S3.4  세부 뷰 (SC-L3)      명세 동 §3                        ⬜
S3.5  명령 메뉴 3종 — 전략·전술·내정. **전부 비차단**        ⬜
