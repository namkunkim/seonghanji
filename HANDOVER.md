...
> 남은 발주자·검수자 닫힘 판정 = **GATE-PRE-07**(라이선스 승인 스냅숏)뿐.
...
>
> **다음 발주자 질문 (한 번에 하나씩):**
> **GATE-PRE-07 (라이선스·외부 실행 규율 — 승인 스냅숏)** — P0-08 완료(V-50~V-54)로 근거는
> 다 섰다. 남은 것은 **P0-09 승인 스냅숏 작성** — 대장 기록 책임·확인일·AI 고지·크레딧·
> 비공개 원고/키 금지·출시 전 재확인 절차를 「착수 승인 시 최소 기록」 6항으로 고정.
> Runway 공식 약관 5항 확인은 S6.1 선행조건으로 이월(부적합 시 로컬 Wan 2.2). 그다음
> 최소 기록 1(범위표 버전 고정)·3(기준선 실제 잠금 = `Q-01`) · D3 조달 순서 · D7 · DEC-04~07.
