...
> 방어 시스템 신설** · D5 = **전투기 설계 선행**(**V-58**, V-57 정정). D4·D5는 각각 `G-08`·`G-09`
> 신규 작업(L1 완성 후 착수). `preproduction-dev-gate.md` §8 에 게이트 승인본 초안이 섰고,
> 남은 것은 발주자·검수자의 닫힘 판정(GATE-PRE-02·03·04·05·07)이다.
...
>
> 발주자 결정 상황: 「영상」 정의(D1) = C 혼합 · **L2 실시간 3D 증거창(D2) = 채택(V-55)** ·
> **D4 무장 위성 방어 = ㉯ 시스템 신설 · D5 전투기 = ㉮ 설계 선행 (V-58, V-57 정정)** ·
> L3 컷씬(D6-1) = 채택(V-52) · D6-2 = Runway 우선·Wan 2.2 폴백(V-54).
> L1 전술 지도는 그대로 필수이고, L2 3D 제작 실착수는 P0-09 승인 후 S5.1(함선 3D 조달 D3,
> 탐색 5일 상한 → 유료·외주 견적)입니다. D4·D5는 각각 `G-08`(무장 위성 시스템 설계 —
> `combat.md` §8.2 등)·`G-09`(기동병기 상세 설계) 신규 작업으로, L1 완성(S4) 후 착수입니다.
>
> **남은 발주자 질문 (한 번에 하나씩):**
> **D3 조달 순서 확정** (CC0 5일 상한 초과 시 A 유료 → B 외주 → C L2 축소) · **D7**(오프닝
> 컷씬 여부, 확인만) · **GATE-PRE 계약 5종**(02·03·04·05·07) · **DEC-04~07**.
>
> 게이트 닫힘 판정(GATE-PRE-02·03·04·05·07)은 발주자·검수자 몫으로 남아 있습니다.
