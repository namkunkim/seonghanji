...
| **A-02** | 저장 지문·변조·손상 복구 인수 | `preproduction-save-contract.md` §3.2·§3.5·§4.2 — 정상/변조 지문, 규칙 세대, 부분 복구, 파일 왕복 | 🟦 `Save.inspect` 분리형 로더 · 지문 검증 결과 API · 손상 명령 직전 복구 · `run_save_restore.gd` 73단언/2 SKIP · 함대 스냅숏 제거. 검수 대기 |
