...
> **P0-09** — 발주자 D2 결정 = **L2 실시간 3D 전투의 3D 증거창 채택**(`DECISIONS.md` **V-55**).
> `preproduction-dev-gate.md` §8 에 게이트 승인본 초안이 섰고, 남은 것은 발주자·검수자의
> 닫힘 판정(GATE-PRE-02·03·04·05·07)이다.
...
- ~~아트·사운드 방향~~ — **명세 완료.** `asset-ledger.md`(물량) + `ai-media-pipeline.md`
  ...
  **P0-04 공용 초상 기준선은 실행 완료** — V-50의 FLUX schnell·v2 스타일 공용 11종이
  ...
  - **시각 방향 P0-07 ✅ 완료 (2026-09-01 · `fd521c5`)** — `visual-direction-guide.md`를
    ...
    `preproduction-ship3d-procurement.md` · D3 착수 S5.1과 함께).
...
> 탐색 5일 상한 → 유료·외주 견적)입니다.
>
> **다음 발주자 질문 하나 (한 번에 하나씩):**
> **D4 — 무장 위성 방어의 지위.** ㉮ 연출뿐(L3 3일) / ㉯ 시스템 신설(주 단위).
> 저장소 전체에서 대응 설계가 `star-map.md` §5 한 줄뿐이라 **시스템 판정이 연출에 선행**합니다.
> 미결 시 기본 처리는 `VID-002` 만 보류(나머지 L3·전 계층 진행). D5(전투기)·GATE-PRE 계약
> 5종·DEC-04~07 은 그 뒤입니다.
>
