...
| `02-characters/officers-256.md` | 일반 무장 256 | |
...
| # | 작업 | 규모 | 비고 |
|---|---|---|---|
| A2 | 일반 무장 256인 스탯 + 성향 확정 | 규칙 적용 후 검수 | `dispositions.md` §6 규칙 있음 |
| A3 | 이역 인물 90인 스탯 | | |
...
B6(표기 통일)는 완료되어 순서에서 제외. 다음은 판단이 필요 없는 A2·A3(스탯)부터 이어간다.
